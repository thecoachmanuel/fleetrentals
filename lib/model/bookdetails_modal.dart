...
class BookDetail {
  ...
  factory BookDetail.fromJson(Map<String, dynamic> json) => BookDetail(
    ...
    carImg: json["car_img"],
    pickLat: ensureNigerianLat(json["pick_lat"], id: json["car_id"]),
    pickLng: ensureNigerianLng(json["pick_lng"], id: json["car_id"]),
    pickAddress: ensureNigerianAddress(json["pick_address"], id: json["car_id"], title: json["car_title"]?.toString() ?? ''),
    cityTitle: ensureNigerianCity(json["city_title"], id: json["car_id"]),
