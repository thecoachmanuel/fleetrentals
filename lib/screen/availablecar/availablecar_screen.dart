  ...
  Future viewFeature(uid, lats, longs, city) async {
    ...
    try{
      var response = await http.post(
        Uri.parse(Config.baseUrl+Config.viewFeature),
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return isLoading ?   awailableCarShimmer() : InkWell(
                      onTap: () {
                        Get.to(CarDetailsScreen(id: viewFeatureModal!.featureCar[index].id, currency: "₦"));
                      },
                      child: Container(
                        height: 160,
                              ...
                              children: [
                                ClipRRect(
                                  ...
                                  child: SizedBox(
                                    height: 90,
                                    width: 140,
                                    child: viewFeatureModal!.featureCar[index].carImg.startsWith('assets/')
                                        ? Image.asset(viewFeatureModal!.featureCar[index].carImg, fit: BoxFit.cover)
                                        : Image.network(
                                            Config.imgUrl + (viewFeatureModal!.featureCar[index].carImg.startsWith('/') ? viewFeatureModal!.featureCar[index].carImg.substring(1) : viewFeatureModal!.featureCar[index].carImg),
                                            fit: BoxFit.cover,
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text("₦${viewFeatureModal?.featureCar[index].carRentPrice}/${viewFeatureModal?.featureCar[index].priceType == '1'? 'hr'.tr : 'days'.tr}", style: TextStyle(fontFamily: FontFamily.europaBold, color: notifire.getwhiteblackcolor, fontSize: 15,),),
                                        ],
                                      ),
                                    ],
                                  ),
